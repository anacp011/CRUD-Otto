...
class App:
    ...
    def abrir_programa_general(self):
        ...
        main_window.config(relief=tk.SOLID)
        ...
        notebook_style.configure("TNotebook.Tab",  font=("Courier New Baltic", 13) , padding=[10, 5])
        
        #MateriaPrimaApp['relief'] = 'solid'
